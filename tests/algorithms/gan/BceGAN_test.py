...
from tf_gen_models.algorithms.gan import BceGAN
...
gan = BceGAN (generator, discriminator, latent_dim = LATENT_DIM)
...
img_saver = ImageSaver ( name = "dc-bce-gan", dirname = "./images/dc-bce-gan", step = 1, look = "multi" )
...
anim_file = "./images/dc-bce-gan.gif"

filenames = glob.glob ("./images/dc-bce-gan/dc-bce-gan_ep*.png")
